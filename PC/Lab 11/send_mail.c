...
int main(int argc, char **argv) {
    ...
    int connectionStatus = connect(sockfd, (struct sockaddr *)&servaddr, sizeof(servaddr));
    if (connectionStatus == -1) 
    {
        printf("cennection error");
        exit(0);
    }
    ...
    sprintf(sendbuf, "MAIL FROM: andreiporumb2018@gmail.com");
    send_command(sockfd, sendbuf, "250");
    // TODO 5: trimiteti comanda de RCPT TO
    sprintf(sendbuf, "RCPT TO: andreiporumb90@yahoo.com");
    send_command(sockfd, sendbuf, "250");
    ...
    char message[MAXLEN];
    sprintf(message, "MIME-Version: 1.0\nFrom: eu\nTo: tu\nSubject: Tema\nContent-Type: multipart/mixed; boundary=abc\n\n--abc\nContent-Type: text/plain\n\nAtasez tema\n\nCu bine,\nStudentul\n\n--abc\nContent-Type: text/plain\nContent-Disposition: attachment; filename=\"file.txt\"\n\n--abc\r\n.");
    send_command(sockfd, message, "250");
