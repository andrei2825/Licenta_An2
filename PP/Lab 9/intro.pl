...
myConcat([],L,L).
myConcat([X|Rest1], L2, [X|Rest2]):- myConcat(Rest1,L2,Rest2).
...
myReverse([],[]).
myReverse([X|Rest1],RevList):- myReverse(Rest1, Rest2), myConcat(Rest2, [X], RevList).
...
myReverseAcc([],L,L).
myReverseAcc([X|Rest1],Acc,L):- myReverseAcc(Rest1,[X|Acc],L).
