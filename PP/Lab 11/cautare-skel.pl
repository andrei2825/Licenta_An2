...
parseState(Mal/NM_Est/NC_Est/NM_Vest/NC_Vest, Mal, NM_Est, NC_Est, NM_Vest, NC_Vest).
...
next_state(misionari, est/NM_Est1/NC_Est1/NM_Vest1/NC_Vest1, vest/NM_Est2/NC_Est2/NM_Vest2/NC_Vest2) :-
    boat(NM, NC),
    NM =< NM_Est1,
    NC =< NC_Est1,
    NM_Est2 is NM_Est1 - NM,
    NC_Est2 is NC_Est1 - NC,
    NM_Vest2 is NM_Vest1 + NM,
    NC_Vest2 is NC_Vest1 + NC,
    safeMisionari(NM_Est2, NC_Est2),
    safeMisionari(NM_Vest2, NC_Vest2).

next_state(misionari, vest/NM_Est1/NC_Est1/NM_Vest1/NC_Vest1, est/NM_Est2/NC_Est2/NM_Vest2/NC_Vest2) :-
    boat(NM, NC),
    NM =< NM_Vest1,
    NC =< NC_Vest1,
    NM_Vest2 is NM_Vest1 - NM,
...
bfs([(Node, Parent)|_], Closed, [(Node, Parent) | Closed]) :-
    final_node(Node).

bfs([(Node, Parent)|Rest], Closed, Sol) :-
    member(Node, Closed),
    bfs(Rest, Closed, Sol).

bfs([(Node, Parent)|Rest], )
